...
public class ContactMessage {
    ...
    @jakarta.validation.constraints.Size(max = 100, message = "Name must be less than 100 characters")
    private String name;
    ...
    @jakarta.validation.constraints.Size(max = 255, message = "Subject must be less than 255 characters")
